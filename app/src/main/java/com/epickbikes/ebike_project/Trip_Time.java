...
import static com.epickbikes.ebike_project.JournyScan_Flashlight.ScanbikeId;
import static com.epickbikes.ebike_project.JournyScan_Flashlight.otp;
import static com.epickbikes.ebike_project.Launching.bikeidlanch;
import static com.epickbikes.ebike_project.Launching.milliseconds;
import static com.epickbikes.ebike_project.Launching.orgIdlanch;
import static com.epickbikes.ebike_project.Launching.otplanch;
import static com.epickbikes.ebike_project.Launching.profileURLlanch;
import static com.epickbikes.ebike_project.Launching.timestart;
import static com.epickbikes.ebike_project.List_places.orgposval;
import static com.epickbikes.ebike_project.List_places.profileURL;
...
public class Trip_Time extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, GoogleMap.OnMarkerClickListener, OnMapReadyCallback,
    ...
    static final AtomicReference<TimerTask> task = new AtomicReference<TimerTask>(null);
    ...
    static double triplat;
    static double triplang;
    Handler handler;

    static List<String> latlangL = new ArrayList<>();
    LatLng latLng;
    ...
    public void shredsave(String orgid) {
        ...
        editor.putString("orgidtrip", orgid);
                            ...
                            try {
                                if(response.has("success")) {
                                    ...
                                    if (errorCode.contentEquals("true")) {
                                      ...
                                      /*  if (mGoogleApiClient != null) {
                                            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, Trip_Time.this);
                                        }
                                        */
  ...
  private Runnable updateTimerMethod = new Runnable() {
    ...
    public void onLocationChanged(final Location location) {
       ...
       /* LatLng latLng = new LatLng(location.getLatitude(), location.getLongitude());
        ...
        // your code here...
        triplat=location.getLatitude();
        triplang=location.getLongitude();
        // Log.d("triplat-----","triplat: " + triplat+":"+triplang);
        // your code here...
        triplat=location.getLatitude();
        triplang=location.getLongitude();
        // Log.d("triplat-----","triplat: " + triplat+":"+triplang);

        latlangL.add(String.valueOf(triplat));
        latlangL.add(String.valueOf(triplang));
       // Log.d("latlangL-----","latlangL: " + latlangL);
        //Toast.makeText(getApplicationContext(), "this is onlocation change"+latlangL, Toast.LENGTH_LONG).show();
        sharedlatlng(String.valueOf(latlangL));
       ...
       /* TimerTask hourlyTask = new TimerTask () {
        ...
        timer.schedule (hourlyTask, 0l, 1000*60*6);   // 1000*10*60 every 10 minut
*/
...
/*
    ...
    public void sharedlatlng(String latlang) {

       // Log.d("..sharedsave data.. ", String.valueOf(latlang));
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(Trip_Time.this);
        SharedPreferences.Editor editor = preferences.edit();
