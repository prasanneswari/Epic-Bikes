...
public class Report_damages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (scaniddamage != null) {
            scaniddamage.setText(Damage_Scan_light.bikeidreportval);

        }
        /*if (Damage_Scan_light.bikeidreportval == null) {
        ...
        submitdamageB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (wheelsC.isChecked()) {
                 ...
                 if (ScanidE.isEmpty()) {
                ...
                else if (!(lockC.isChecked()) && !(frameC.isChecked()) && !(handleC.isChecked()) && !(brakesC.isChecked()) && !(batteryC.isChecked()) && !(wheelsC.isChecked())) {
                    //submitdamageB.setVisibility(View.INVISIBLE);
                    ...
                    if (List_places.orgposval != null) {
                        ...
                        String damageS = "{\"orgId\":\"" + List_places.orgposval + "\",\"access_token\":\"" + accesstoken + "\",\"bikeId\":\"" + ScanidE + "\",\"comment\":\"" + commentE + "\",\"damage\":" + damageL + ",\"url\":" + imagedisplyL + "}";
                       // Log.d("sending string is :", damageS.toString());
                        Log.d("jsnresponse orgposval", "---" + damageS);
                        ...
                        String damageS = "{\"orgId\":\"" + Launching.orgIdlanch + "\",\"access_token\":\"" + accesstoken + "\",\"bikeId\":\"" + ScanidE + "\",\"comment\":\"" + commentE + "\",\"damage\":" + damageL + ",\"url\":" + imagedisplyL + "}";
                      //  Log.d("sending string is :", damageS.toString());
                        Log.d("jsnresponse orgIdlanch", "---" + damageS);
                        String damage_url = "https://epickbikes.com/api/v1/damage/add";
                        JSONObject lstrmdt = null;
                        ...
                        String damageS = "{\"orgId\":\"" + orgIdlogin + "\",\"access_token\":\"" + accesstoken + "\",\"bikeId\":\"" + ScanidE + "\",\"comment\":\"" + commentE + "\",\"damage\":" + damageL + ",\"url\":" + imagedisplyL + "}";
                       // Log.d("sending string is :", damageS.toString());
                        Log.d("jsnresponse orgIdlogin", "---" + damageS);
                        String damage_url = "https://epickbikes.com/api/v1/damage/add";
                        JSONObject lstrmdt = null;
                        ...
                        String damageS = "{\"orgId\":\"" + Launching.sharedsaveorgid + "\",\"access_token\":\"" + accesstoken + "\",\"bikeId\":\"" + ScanidE + "\",\"comment\":\"" + commentE + "\",\"damage\":" + damageL + ",\"url\":" + imagedisplyL + "}";
                      //  Log.d("sending string is :", damageS.toString());
                        Log.d("jsnresponse sharedsav", "---" + damageS);
                        String damage_url = "https://epickbikes.com/api/v1/damage/add";
                        JSONObject lstrmdt = null;
                            ...
                            if (response.has("success")) {
                                try {
                                    ...
                                    if (errorCode.contentEquals("true")) {
                                        ...
                                        textpopup.setText("Successfully reported");
...
*/
   ...
   /* public void ChooseImage() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK) {
          //  Log.d("enterd11", "resultCode" +resultCode );
          //  Log.d("enterd22", "requestCode" +requestCode );
          //  Log.d("enterd33", "imageReturnedIntent" +imageReturnedIntent );
          //  Log.d("enterd55", "get data" +imageReturnedIntent.getData() );

            if (imageReturnedIntent.getClipData() != null || imageReturnedIntent.getData() != null ) {
              //  Log.d("enterd44", "imageReturnedIntent:" +imageReturnedIntent);

                Uri uriimg=imageReturnedIntent.getData();
              //  Log.d("enterd66", "imageReturnedIntent:" +uriimg);
                if (uriimg !=null){
