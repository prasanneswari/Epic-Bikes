...
public class Wallet extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    public void generatecheck(){
        ...
        if (orgposval != null) {
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + orgposval + "\",\"TXN_AMOUNT\":\"" + txnamount + "\"}";
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + Launching.orgIdlanch + "\",\"TXN_AMOUNT\":\"" + txnamount + "\"}";
           // Log.d("sending string is :", param.toString());
            Log.d("jsnresponse AddS", "---" + param);
            String cheksum_url = "https://epickbikes.com/api/v1/transaction/generateChecksum";
            JSONObject lstrmdt = null;
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + orgIdlogin + "\",\"TXN_AMOUNT\":\"" + txnamount + "\"}";
           // Log.d("sending string is :", param.toString());
            Log.d("jsnresponse AddS", "---" + param);
            String cheksum_url = "https://epickbikes.com/api/v1/transaction/generateChecksum";
            JSONObject lstrmdt = null;
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + Launching.sharedsaveorgid + "\",\"TXN_AMOUNT\":\"" + txnamount + "\"}";
            //Log.d("sending string is :", param.toString());
            Log.d("jsnresponse AddS", "---" + param);
            String cheksum_url = "https://epickbikes.com/api/v1/transaction/generateChecksum";
            JSONObject lstrmdt = null;
    ...
    public void verifycheck() {
        ...
        if (orgposval != null) {
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + Launching.orgIdlanch + "\",\"params\":{\"STATUS\":\"" + STATUSverify + "\",\"BANKNAME\":\"" + BANKNAMEverify + "\",\"ORDERID\":\"" + ORDERIDverify + "\",\"TXNAMOUNT\":\"" + TXNAMOUNTverify + "\",\"TXNDATE\":\"" + TXNDATEverify + "\",\"MID\":\"" + MIDverify + "\",\"TXNID\":\"" + TXNIDverify + "\",\"RESPCODE\":\"" + RESPCODEverify + "\",\"PAYMENTMODE\":\"" + PAYMENTMODEverify + "\",\"BANKTXNID\":\"" + BANKTXNIDverify + "\",\"CHECKSUMHASH\":\"" + CHECKSUMHASHverify + "\",\"CURRENCY\":\"" + CURRENCYverify + "\",\"GATEWAYNAME\":\"" + GATEWAYNAMEverify + "\",\"RESPMSG\":\"" + RESPMSGverify + "\"}}";
          //  Log.d("sending string is :", param.toString());
            Log.d("jsnresponse AddS", "---" + param);
            String cheksum_url = "https://epickbikes.com/api/v1/transaction/verifyChecksum";
            JSONObject lstrmdt = null;
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + orgIdlogin + "\",\"params\":{\"STATUS\":\"" + STATUSverify + "\",\"BANKNAME\":\"" + BANKNAMEverify + "\",\"ORDERID\":\"" + ORDERIDverify + "\",\"TXNAMOUNT\":\"" + TXNAMOUNTverify + "\",\"TXNDATE\":\"" + TXNDATEverify + "\",\"MID\":\"" + MIDverify + "\",\"TXNID\":\"" + TXNIDverify + "\",\"RESPCODE\":\"" + RESPCODEverify + "\",\"PAYMENTMODE\":\"" + PAYMENTMODEverify + "\",\"BANKTXNID\":\"" + BANKTXNIDverify + "\",\"CHECKSUMHASH\":\"" + CHECKSUMHASHverify + "\",\"CURRENCY\":\"" + CURRENCYverify + "\",\"GATEWAYNAME\":\"" + GATEWAYNAMEverify + "\",\"RESPMSG\":\"" + RESPMSGverify + "\"}}";
           // Log.d("sending string is :", param.toString());
            Log.d("jsnresponse AddS", "---" + param);
            String cheksum_url = "https://epickbikes.com/api/v1/transaction/verifyChecksum";
            JSONObject lstrmdt = null;
            ...
            String param = "{\"access_token\":\"" + accesstoken + "\",\"orgId\":\"" + Launching.sharedsaveorgid + "\",\"params\":{\"STATUS\":\"" + STATUSverify + "\",\"BANKNAME\":\"" + BANKNAMEverify + "\",\"ORDERID\":\"" + ORDERIDverify + "\",\"TXNAMOUNT\":\"" + TXNAMOUNTverify + "\",\"TXNDATE\":\"" + TXNDATEverify + "\",\"MID\":\"" + MIDverify + "\",\"TXNID\":\"" + TXNIDverify + "\",\"RESPCODE\":\"" + RESPCODEverify + "\",\"PAYMENTMODE\":\"" + PAYMENTMODEverify + "\",\"BANKTXNID\":\"" + BANKTXNIDverify + "\",\"CHECKSUMHASH\":\"" + CHECKSUMHASHverify + "\",\"CURRENCY\":\"" + CURRENCYverify + "\",\"GATEWAYNAME\":\"" + GATEWAYNAMEverify + "\",\"RESPMSG\":\"" + RESPMSGverify + "\"}}";
           // Log.d("sending string is :", param.toString());
            Log.d("jsnresponse AddS", "---" + param);
            String cheksum_url = "https://epickbikes.com/api/v1/transaction/verifyChecksum";
            JSONObject lstrmdt = null;
