...
import static com.epickbikes.ebike_project.End_trips._id;
import static com.epickbikes.ebike_project.Launching.latlangtrip_time;
import static com.epickbikes.ebike_project.Launching.orgIdlanch;
import static com.epickbikes.ebike_project.Launching.sharedsaveorgid;
...
import static com.epickbikes.ebike_project.Trip_Time.latlangL;
...
public class Trip_summary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("latlangtrip_time","latlangtrip_time"+latlangtrip_time);
        Log.d("latlangL","latlangL"+latlangL);
            ...
            public void onClick(View view) {
                ...
                if(ratingval==null) {
                    ...
                    if (_id != null) {
                            ...
                            if (latlangL != null) {
                                if (orgposval != null) {
                                    String ratingS = "{\"tripId\":\"" + _id + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgposval + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangL + "\"}";
                                    // Log.d("sending string is :", ratingS.toString());
                                    Log.d("jsnresponse orgposval", "---" + ratingS);
                                    ...
                                    try {
                                        ...
                                        String ratingS = "{\"tripId\":\"" + _id + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlanch + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangL + "\"}";
                                        // Log.d("sending string is :", ratingS.toString());
                                        Log.d("jsnresponse orgIdlanch", "---" + ratingS);
                                        String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                        JSONObject lstrmdt = null;
                                    ...
                                    String ratingS = "{\"tripId\":\"" + _id + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlogin + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangL + "\"}";
                                    // Log.d("sending string is :", ratingS.toString());
                                    Log.d("jsnresponse orgIdlogin", "---" + ratingS);
                                    String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                    JSONObject lstrmdt = null;
                            ...
                            } else if (latlangtrip_time != null) {
                                if (orgposval != null) {

                                    String ratingS = "{\"tripId\":\"" + _id + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgposval + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangtrip_time + "\"}";
                                    // Log.d("sending string is :", ratingS.toString());
                                    Log.d("jsnresponse orgIdlanch1", "---" + ratingS);
                                    String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                    JSONObject lstrmdt = null;
                                    ...
                                    String ratingS = "{\"tripId\":\"" + _id + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlanch + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangtrip_time + "\"}";
                                    // Log.d("sending string is :", ratingS.toString());
                                    Log.d("jsnresponse orgIdlanch1", "---" + ratingS);
                                    String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                    JSONObject lstrmdt = null;
                                    ...
                                    String ratingS = "{\"tripId\":\"" + _id + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlogin + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangtrip_time + "\"}";
                                    // Log.d("sending string is :", ratingS.toString());
                                    Log.d("jsnresponse orgIdlogin1", "---" + ratingS);
                                    String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                    JSONObject lstrmdt = null;
                       ...
                       /* if (orgposval != null) {
                        ...
                        if (latlangL != null) {
                            if (orgposval != null) {
                                String ratingS = "{\"tripId\":\"" + _idTripsummary + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgposval + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangL + "\"}";
                                // Log.d("sending string is :", ratingS.toString());
                                Log.d("jsnresponse orgposval2", "---" + ratingS);
                                String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                JSONObject lstrmdt = null;
                                ...
                                String ratingS = "{\"tripId\":\"" + _idTripsummary + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlanch + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangL + "\"}";
                                // Log.d("sending string is :", ratingS.toString());
                                Log.d("jsnresponse orgIdlanch2", "---" + ratingS);
                                String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                JSONObject lstrmdt = null;
                                ...
                                String ratingS = "{\"tripId\":\"" + _idTripsummary + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlogin + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangL + "\"}";
                                // Log.d("sending string is :", ratingS.toString());
                                Log.d("jsnresponse orgIdlogin2", "---" + ratingS);
                                String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                JSONObject lstrmdt = null;
                            ...
                            if (orgposval != null) {
                                ...
                                String ratingS = "{\"tripId\":\"" + _idTripsummary + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgposval + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangtrip_time + "\"}";
                                // Log.d("sending string is :", ratingS.toString());
                                Log.d("jsnresponse orgIdlanch3", "---" + ratingS);
                                String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                JSONObject lstrmdt = null;
                                ...
                                String ratingS = "{\"tripId\":\"" + _idTripsummary + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlanch + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangtrip_time + "\"}";
                                // Log.d("sending string is :", ratingS.toString());
                                Log.d("jsnresponse orgIdlanch3", "---" + ratingS);
                                String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                JSONObject lstrmdt = null;
                                ...
                                String ratingS = "{\"tripId\":\"" + _idTripsummary + "\",\"rating\":\"" + ratingval + "\",\"orgId\":\"" + orgIdlogin + "\",\"access_token\":\"" + accesstoken + "\",\"gpsLocations\":\"" + latlangtrip_time + "\"}";
                                // Log.d("sending string is :", ratingS.toString());
                                Log.d("jsnresponse orgIdlogin3", "---" + ratingS);
                                String rating_url = "https://epickbikes.com/api/v1/trips/rating-update";
                                JSONObject lstrmdt = null;
                                ...
                                try {
                                    ...
                                    if (errorCode.contentEquals("true")){
                                        ...
                                        if (dataArray.length() == 1) {
                                            ...
                                            SharedPreferences.Editor editor = getlistplacesval.edit();
                                            editor.remove("orgidtrip");
                                            editor.commit();
