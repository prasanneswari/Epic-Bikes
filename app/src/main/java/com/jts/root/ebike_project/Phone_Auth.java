...
import static com.jts.root.ebike_project.MyFirebase_InstanceId_Service.refreshedToken;
import static com.jts.root.ebike_project.Register.phoneNum;
...
public class Phone_Auth extends AppCompatActivity {
    ...
    public void notificationtoken(){
        ...
        String notificationS = "{\"access_token\":\"" + accesstoken + "\",\"notificationKey\":\"" + refreshedToken + "\"}";
...
*/
                                            for (int i = 0; i < dataArray.length(); i++) {
                                                ...
                                                Intent intent = new Intent(Phone_Auth.this, Splash_Screen.class);
                                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                startActivity(intent);
                                            }
                                        }else {
